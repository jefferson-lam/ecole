...
template <> ECOLE_EXPORT [[nodiscard]] auto Model::get_param<ParamType::Bool>(std::string const& name) const -> bool;
template <> ECOLE_EXPORT [[nodiscard]] auto Model::get_param<ParamType::Int>(std::string const& name) const -> int;
template <>
ECOLE_EXPORT [[nodiscard]] auto Model::get_param<ParamType::LongInt>(std::string const& name) const -> SCIP_Longint;
template <>
ECOLE_EXPORT [[nodiscard]] auto Model::get_param<ParamType::Real>(std::string const& name) const -> SCIP_Real;
template <> ECOLE_EXPORT [[nodiscard]] auto Model::get_param<ParamType::Char>(std::string const& name) const -> char;
template <>
ECOLE_EXPORT [[nodiscard]] auto Model::get_param<ParamType::String>(std::string const& name) const -> std::string;
